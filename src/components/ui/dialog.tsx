...
const DialogHeader = ({ className, ...props }: ComponentProps<"div">) => {
  return (
    <div
      ...
      className={mergeClassNames("flex flex-col gap-2 text-center sm:text-left", className)}
      {...props}
    />
  );
}
...
const DialogTitle = ({ className, ...props }: ComponentProps<typeof DialogPrimitive.Title>) => {
  return (
    <DialogPrimitive.Title
      ...
      className={mergeClassNames("text-lg leading-none font-semibold", className)}
      {...props}
    />
  );
}
