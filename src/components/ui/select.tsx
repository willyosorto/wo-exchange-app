...
const SelectTrigger = ({ className, size = "default", children, ...props }: ComponentProps<typeof SelectPrimitive.Trigger> & {
  size?: "sm" | "default";
}) => {
  return (
...
const SelectContent = ({ className, children, position = "popper", ...props }: ComponentProps<typeof SelectPrimitive.Content>) => {
  return (
...
const SelectLabel = ({ className, ...props }: ComponentProps<typeof SelectPrimitive.Label>) => {
  return (
    <SelectPrimitive.Label
      ...
      className={mergeClassNames("text-muted-foreground px-2 py-1.5 text-xs", className)}
      {...props}
    />
  );
}
...
const SelectSeparator = ({ className, ...props }: ComponentProps<typeof SelectPrimitive.Separator>) => {
  return (
    <SelectPrimitive.Separator
      ...
      className={mergeClassNames("bg-border pointer-events-none -mx-1 my-1 h-px", className)}
      {...props}
    />
  );
}
